  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/image.png" alt="${productName}" border="0" />
        <h1>Welcome to <strong>EmergentAI KeyCloak Identity Service</strong></h1>
      </div>
      <div class="row">
      ...
      <div class='footer'>
        <#if properties.displayCommunityLinks = "true">
            <div>© EmergentAI All rights reserved.</div>
        </#if>
      </div>
    </div>
  </div>
